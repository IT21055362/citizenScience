                ...
                <div className="col-12">
                    <div className="row" style={{ margin: "60px 0 30px" }}>
                        <div className="col-12">
                            ...
                            <h1 style={{ margin: "20px 0 0 0", textAlign: "center", fontWeight: "600" }}>Report Active / Inactive Status Report</h1>
                        </div>
                    </div>
                    <div className="col-12">
                                            ...
                                            data.map((Report) => {
                                                return (
                                                    <tr key={Report._id}>
                                                        ...
                                                        <td>{Report.companyPhoneNo}</td>
                                                        <td>{Report.rawMaterial}</td>
                                                        <td>{Report.contactPersonName}</td>
                                                        <td>{Report.contactPersonPhoneNo}</td>
                                                        <td>{Report.contactPersonEmail}</td>
                                                    </tr>
                                                );
                                            })}
                                    </tbody>
